					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<a class="btn btn-default" href="${pageContext.request.contextPath}/requestFormAdmin/select" role="button">
									<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Към Търсене
								</a>								
							</div>
						</div>			  	
						...
						<div class="col-xs-6">							
							<div class="update text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/requestFormAdmin/update"
									...
									<form:hidden path="requestId" value="${adminHelperFormExistingRequest.requestId}" />			       
									<form:hidden path="requesterId" value="${adminHelperFormExistingRequest.requesterId}" />
									<form:hidden path="dateSelected" value="${adminHelperFormExistingRequest.dateSelected}" />
									<form:hidden path="requesterComment" value="${adminHelperFormExistingRequest.requesterComment}" />
									
									<form:hidden path="checkBoxInService" value="${adminHelperFormExistingRequest.checkBoxInService}" />
									<form:hidden path="objectTypeIdInService" value="${adminHelperFormExistingRequest.objectTypeIdInService}" />
									<form:hidden path="objectModelIdInService" value="${adminHelperFormExistingRequest.objectModelIdInService}" />
									<form:hidden path="objectInstanceIdInService" value="${adminHelperFormExistingRequest.objectInstanceIdInService}" />
									
									<form:hidden path="checkBoxInOperation" value="${adminHelperFormExistingRequest.checkBoxInOperation}" />
									<form:hidden path="objectTypeIdInOperation" value="${adminHelperFormExistingRequest.objectTypeIdInOperation}" />
									<form:hidden path="objectModelIdInOperation" value="${adminHelperFormExistingRequest.objectModelIdInOperation}" />
									<form:hidden path="objectInstanceIdInOperation" value="${adminHelperFormExistingRequest.objectInstanceIdInOperation}" />
																											
									<form:hidden path="itemComment" value="${adminHelperFormExistingRequest.itemComment}" />
