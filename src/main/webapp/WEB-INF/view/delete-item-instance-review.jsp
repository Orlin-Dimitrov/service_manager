...
<head>
	<title>Преглед Изтриване Сериен номер на Устройство</title>
	<meta charset="utf-8">
							...
							<div class="panel panel-object" id="panelObjectInfo">
								...
								<table class="table ">								
									<tr>
										...
										<td class="col-xs-8 text-center" >${deleteObjectInstance.type}</td>
									</tr>
									
									<tr>
										<td class="right">Модел</td>
										<td>${deleteObjectInstance.model}</td>
									</tr>									
									
									<tr>
										<td class="right">Сериен номер</td>
										<td class="active-object" >${deleteObjectInstance.instance}</td>
									</tr>									
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Изтриване Сериен номер на устройство от База Данни</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/componentDelete/deleteInstance"
													   modelAttribute="deleteObjectInstance"
												       class="form-horizontal"
												       method="POST">

									<form:hidden id="instanceIdEdit" path="instanceId" value="${deleteObjectInstance.instanceId}" />
									
									<form:hidden id="modelIdEdit" path="modelId" value="${deleteObjectInstance.modelId}" />

									<form:hidden id="typeIdEdit" path="typeId" value="${deleteObjectInstance.typeId}" />									
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/componentDelete/saveDeleteInstance"
													   modelAttribute="deleteObjectInstanceForSaving"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="instanceIdSave" path="instanceId" value="${deleteObjectInstance.instanceId}" />
									
									<form:hidden id="modelIdSave" path="modelId" value="${deleteObjectInstance.modelId}" />

									<form:hidden id="typeIdSave" path="typeId" value="${deleteObjectInstance.typeId}" />
