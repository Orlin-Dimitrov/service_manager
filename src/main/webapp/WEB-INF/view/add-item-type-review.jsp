...
<head>
	<title>Преглед на НОВ Тип устройство</title>
	<meta charset="utf-8">
							...
							<div class="panel panel-object" id="panelObjectInfo">
								...
								<table class="table ">								
									<tr>
										...
										<td class="col-xs-8 text-center active-object" >${newObjectType.type}</td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Само Администратор може да променя или изтрива Тип устройство!</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/component/addType"
													   modelAttribute="newObjectType"
												       class="form-horizontal"
												       method="POST">
									<form:hidden id="typeEdit" path="type" value="${newObjectType.type}" />									
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/component/saveType"
													   modelAttribute="newObjectTypeForSaving"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="typeSave" path="type" value="${newObjectType.type}" />	
