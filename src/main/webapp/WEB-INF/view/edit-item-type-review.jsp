...
<head>
	<title>Преглед на Редактиране Тип Устройство</title>
	<meta charset="utf-8">
							...
							<div class="panel panel-object" id="panelObjectInfo">
								...
								<table class="table ">								
									<tr>
										...
										<td class="col-xs-8 text-center active-object" >${editObjectType.type}</td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Тази промяна се отнася за ВСИЧКИ Модели и Серийни номера на Тип Устройство:</div>
									
									<div class="modifiedObject">
										${editObjectType.oldType}
									</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/componentEdit/editType"
													   modelAttribute="editObjectType"
												       class="form-horizontal"
												       method="POST">
									<form:hidden id="typeEdit" path="type" value="${editObjectType.type}" />
									<form:hidden id="typeIdEdit" path="typeId" value="${editObjectType.typeId}" />									
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/componentEdit/saveEditType"
													   modelAttribute="editObjectTypeForSaving"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="typeSave" path="type" value="${editObjectType.type}" />
									<form:hidden id="typeIdSave" path="typeId" value="${editObjectType.typeId}" />
