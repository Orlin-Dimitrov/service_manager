...
<head>
	...
	<title>Изтрий Сериен номер на Устройство</title>
	<meta charset="utf-8">
	...
	<script type="text/javascript">
		...
		var typeId = <c:out value="${deleteObjectInstance.typeId}" />;		
		var modelId = <c:out value="${deleteObjectInstance.modelId}" />;		
		var instanceId = <c:out value="${deleteObjectInstance.instanceId}" />;
				...
				<div id="inputbox" class="mainbox">
					<div class="panel delete-color panel-delete" >
						...
						<div class="panel-heading delete-color-heading">
							<div class="panel-title">Изтрий Сериен номер на устройство</div>
						</div>
		
						<div class="panel-body">
		
							<!-- Add Type Form -->
							<form:form action="${pageContext.request.contextPath}/componentDelete/reviewDeleteInstance"
									   modelAttribute="deleteObjectInstance" 
									   method="POST" 
								       class="form-horizontal"
								       id="deleteInstanceForm">								
								...
								<div class="row form-group form-group-custom">
									<label for="objectInstancesFromJSON" >Сериен номер за изтриване</label>							
									<div>
