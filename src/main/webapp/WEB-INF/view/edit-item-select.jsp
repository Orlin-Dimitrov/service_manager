...
<head>
	...
	<title>Редактирай Устройство</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="jumbotron vertical-center " >
		<div class="container">
				...
				<div id="edititembox" class="mainbox ">
					<div class="panel edit-color panel-edit" >
		
						<div class="panel-heading edit-color-heading">
							<div class="panel-title">Редактирай Устройство</div>
						</div>
		
						<div class="panel-body">		
							<div>
								<a class="btn btn-default btn-lg customButton btn-block" href="${pageContext.request.contextPath}/componentEdit/editType" role="button">Тип</a>
							</div>
							<div>
								<a class="btn btn-default btn-lg customButton btn-block" href="${pageContext.request.contextPath}/componentEdit/editModel" role="button">Модел</a>
							</div>
							<div>
								<a class="btn btn-default btn-lg customButton btn-block" href="${pageContext.request.contextPath}/componentEdit/editInstance" role="button">Сериен номер</a>																			
							</div>
						</div>
