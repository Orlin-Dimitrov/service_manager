...
<head>
	<title>Серийният номер Записан</title>
	<meta charset="utf-8">
				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-green">							
						<div class="panel-heading panel-green-heading">
							<div class="panel-title text-center">Серийният номер Записан!</div>
						</div>

						<div class="panel-body">																
							<div class="well well-result text-center" >
								<span class="glyphicon glyphicon-ok green-text" aria-hidden="true"></span>
								&nbsp;Нов Сериен номер на устройство е записан!										
							</div>								
							
							<div class="row"> 	   
								<div class="cancel text-center">
									<a class="btn btn-default btn-center" href="${pageContext.request.contextPath}/component/addItem" role="button">Към добавяне на устройство</a>
								</div>
							</div><!-- end row -->
