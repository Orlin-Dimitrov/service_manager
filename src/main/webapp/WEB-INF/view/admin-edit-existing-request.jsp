...
<!--
  ...
  -->
	...
	<script type="text/javascript">
	var requesterId = <c:out value="${adminHelperFormExistingRequest.requesterId}" />;
	$(document).ready(
			function () {				
				if(requesterId == 0){
	...
	<script type="text/javascript">
		...
		var checkBox = {
				InService : <c:out value="${adminHelperFormExistingRequest.checkBoxInService}" />,
				InOperation : <c:out value="${adminHelperFormExistingRequest.checkBoxInOperation}" />
		}
		
		var objectTypeId = {
				InService : <c:out value="${adminHelperFormExistingRequest.objectTypeIdInService}" />,
				InOperation : <c:out value="${adminHelperFormExistingRequest.objectTypeIdInOperation}" />
		}
		
		var objectModelId = {
				InService : <c:out value="${adminHelperFormExistingRequest.objectModelIdInService}" />,
				InOperation : <c:out value="${adminHelperFormExistingRequest.objectModelIdInOperation}" />
		}
		
		var objectInstanceId = {
			InService : <c:out value="${adminHelperFormExistingRequest.objectInstanceIdInService}" />,
			InOperation : <c:out value="${adminHelperFormExistingRequest.objectInstanceIdInOperation}" />
		}
...
<body>
	...
	<div class="jumbotron vertical-center " id="mainView">
		<div class="container">
			...
			<div class="row">
				<div id="adminEditRequest" class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
					<div class="panel panel-danger" >
						...
						<div class="col-xs-12" >
							...
							<!-- Registration Form -->
							<form:form action="${pageContext.request.contextPath}/requestFormAdmin/review"
								...
								<div class="row notModifiebleGroup">								
									<div class="col-xs-12 col-sm-10 col-md-8 col-lg-8 ">
										...
										<span class="notModifiebleText">${adminHelperFormExistingRequest.requestId}</span>
								...
								<div class="row notModifiebleGroup">								
									<div class="col-xs-12 col-sm-10 col-md-8 col-lg-8">
										...
										<span class="notModifiebleText" >${adminHelperFormExistingRequest.dateSelected}</span>
