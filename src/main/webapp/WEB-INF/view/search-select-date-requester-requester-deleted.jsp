...
<head>
	<title>Грешка Търсене Дата / Заявител</title>
	<meta charset="utf-8">
				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-red">							
						<div class="panel-heading panel-red-heading">
							<div class="panel-title text-center">Грешка Търсене Дата / Заявител!</div>
						</div>
						...
						<div class="panel-body">																
							...
							<div class="row"> 	   
								<div class="text-center">
									<a class="btn btn-default btn-center" href="${pageContext.request.contextPath}/search/selectDateRequester" role="button">Към Търсене</a>
								</div>	
							</div><!-- end row -->
