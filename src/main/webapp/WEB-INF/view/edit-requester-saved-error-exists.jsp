...
<head>
	<title>Грешка при редактиране на Заявител</title>
	<meta charset="utf-8">
				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-red">							
						<div class="panel-heading panel-red-heading">
							<div class="panel-title text-center">Грешка при редактиране на Заявител!</div>
						</div>
						...
						<div class="panel-body">																
							<div class="well well-result text-center" >
								...
								&nbsp;Заявител с това име вече съществува!											
