...
<head>
	<title>Заявител Редактиран</title>
	<meta charset="utf-8">
				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-green">							
						<div class="panel-heading panel-green-heading">
							<div class="panel-title text-center">Заявител Редактиран!</div>
						</div>
						...
						<div class="panel-body">																
							<div class="well well-result text-center" >
								...
								&nbsp;Редактирания Заявител е записан!											
								
							</div>								
							
							<div class="row"> 	   
								<div class="cancel text-center">
									<a class="btn btn-default btn-center" href="${pageContext.request.contextPath}/componentEdit/editRequester" role="button">Към редактиране на заявител</a>
								</div>
							</div><!-- end row -->
