				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-green">							
						<div class="panel-heading panel-green-heading">
							<div class="panel-title text-center">Заявител Изтрит!</div>
						</div>
						...
						<div class="panel-body">																
							...
							<div class="row"> 	   
								<div class="cancel text-center">
									<a class="btn btn-default btn-center" href="${pageContext.request.contextPath}/componentDelete/deleteRequester" role="button">Към изтриване на заявител</a>
								</div>
							</div><!-- end row -->
