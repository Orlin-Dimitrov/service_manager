...
<head>
	<title>Серийният номер Редактиран</title>
	<meta charset="utf-8">
		...
		<div class="container">
				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-green">							
						<div class="panel-heading panel-green-heading">
							<div class="panel-title text-center">Серийният номер Редактиран!</div>
						</div>

						<div class="panel-body">																
							<div class="well well-result text-center" >
								
								<span class="glyphicon glyphicon-ok green-text" aria-hidden="true"></span>
								&nbsp;Редактирания Сериен номер на устройство е записан!										
								
							</div>								
							
							<div class="row"> 	   
								<div class="cancel text-center">
									<a class="btn btn-default btn-center" href="${pageContext.request.contextPath}/componentEdit/editItem" role="button">Към редактиране на устройство</a>
								</div>
							</div><!-- end row -->
