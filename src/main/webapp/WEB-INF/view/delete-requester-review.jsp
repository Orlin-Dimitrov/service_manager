...
<head>
	<title>Преглед Изтриване на Заявител</title>
	<meta charset="utf-8">
					...
					<div class="row" >
						<div class="col-xs-12" >				
							<div class="panel panel-object" id="panelObjectInfo">
								<div class="panel-heading ">Заявител за Изтриване</div>
							
								<table class="table ">								
									<tr>
										<td class="col-xs-4 right">Заявител</td>
										<td class="col-xs-8 text-center active-object" >${deleteRequester.name}</td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Изтриване на Заявител от База Данни</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/componentDelete/deleteRequester"
													   modelAttribute="deleteRequester"
												       class="form-horizontal"
												       method="POST">

									<form:hidden id="idEdit" path="id" value="${deleteRequester.id}" />									
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/componentDelete/saveDeleteRequester"
													   modelAttribute="deleteRequesterForSaving"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="idSave" path="id" value="${deleteRequester.id}" />
