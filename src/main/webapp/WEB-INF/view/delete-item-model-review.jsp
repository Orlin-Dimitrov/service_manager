...
<head>
	<title>Преглед на Изтриване Модел Устройство</title>
	<meta charset="utf-8">
							...
							<div class="panel panel-object" id="panelObjectInfo">
								...
								<table class="table ">								
									<tr>
										...
										<td class="col-xs-8 text-center" >${deleteObjectModel.type}</td>
									</tr>
									
									<tr>
										<td class="right">Модел</td>
										<td class="active-object" >${deleteObjectModel.model}</td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Изтриване на Модел устройство от База Данни</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/componentDelete/deleteModel"
													   modelAttribute="deleteObjectModel"
												       class="form-horizontal"
												       method="POST">

									<form:hidden id="modelIdEdit" path="modelId" value="${deleteObjectModel.modelId}" />

									<form:hidden id="typeIdEdit" path="typeId" value="${deleteObjectModel.typeId}" />									
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/componentDelete/saveDeleteModel"
													   modelAttribute="deleteObjectModelForSaving"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="modelIdSave" path="modelId" value="${deleteObjectModel.modelId}" />
					       
					       			<form:hidden id="typeIdSave" path="typeId" value="${deleteObjectModel.typeId}" />	
