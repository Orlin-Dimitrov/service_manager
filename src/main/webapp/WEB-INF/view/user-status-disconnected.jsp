...
<head>
	...
	<title>Връзката на Потребителя Прекъсната</title>
	<meta charset="utf-8">
				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-green">							
						<div class="panel-heading panel-green-heading">
							<div class="panel-title text-center">Успешно Прекъсване!</div>
						</div>

						<div class="panel-body">																
							<div class="well well-result text-center" >
								<span class="glyphicon glyphicon-ok green-text" aria-hidden="true"></span>
								&nbsp;Връзката на Потребителя е Прекъсната!											
							</div>								
							
							<div class="row"> 	   
								<div class="cancel text-center">
									<a class="btn btn-default btn-center" href="${pageContext.request.contextPath}/userManagement/list" role="button">Към Списък</a>
								</div>
							</div><!-- end row -->
