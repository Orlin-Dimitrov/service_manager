...
<head>
	...
	<title>Изтрий Тип Устройство</title>
	<meta charset="utf-8">
	...
	<script type="text/javascript">
		...
		var typeId = <c:out value="${deleteObjectType.typeId}" />;
				...
				<div id="inputbox" class="mainbox">
					<div class="panel delete-color panel-delete" >
						...
						<div class="panel-heading delete-color-heading">
							<div class="panel-title">Изтрий Тип устройство</div>
						</div>
		
						<div class="panel-body">
		
							<!-- Delete Type Form -->
							<form:form action="${pageContext.request.contextPath}/componentDelete/reviewDeleteType"
								...
								<div class="row form-group form-group-custom">
									<label for="objectTypesFromJSON" >Тип за изтриване</label>							
									<div>
