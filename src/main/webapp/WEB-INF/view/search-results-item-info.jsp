						...
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/search/resultsItem"
									...
									<form:hidden path="dateStart" value="${searchItemToInfo.dateStart}" />
									<form:hidden path="dateEnd" value="${searchItemToInfo.dateEnd}" />	
									<form:hidden path="requesterId" value="${searchItemToInfo.requesterId}" />	
									<form:hidden path="objectTypeId" value="${searchItemToInfo.objectTypeId}" />	
									<form:hidden path="objectModelId" value="${searchItemToInfo.objectModelId}" />	
									<form:hidden path="objectInstanceId" value="${searchItemToInfo.objectInstanceId}" />
											
									<form:hidden path="dataTablesUniqueId" value="${searchItemToInfo.dataTablesUniqueId}" />																				
