...
<head>
	<title>Грешка при запис на Модел устройство</title>
	<meta charset="utf-8">
				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-red">							
						<div class="panel-heading panel-red-heading">
							<div class="panel-title text-center">Грешка при запис на Модел!</div>
						</div>

						<div class="panel-body">																
							<div class="well well-sm well-result text-center" >
								
								<span class="glyphicon glyphicon-warning-sign red-text" aria-hidden="true"></span>
								&nbsp;Типът за този Модел устройство е изтрит!											
