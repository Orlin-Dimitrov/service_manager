...
<head>
	...
	<title>Изтрий Модел Устройство</title>
	<meta charset="utf-8">
	...
	<script type="text/javascript">
		...
		var typeId = <c:out value="${deleteObjectModel.typeId}" />;
		
		var modelId = <c:out value="${deleteObjectModel.modelId}" />;
				...
				<div id="inputbox" class="mainbox">
					<div class="panel delete-color panel-delete" >
						...
						<div class="panel-heading delete-color-heading">
							<div class="panel-title">Изтрий Модел устройство</div>
						</div>
		
						<div class="panel-body">
		
							<!-- Add Type Form -->
							<form:form action="${pageContext.request.contextPath}/componentDelete/reviewDeleteModel"
								...
								<!-- Select Model Name -->
								<div class="row form-group form-group-custom">
									<label for="objectModelsFromJSON" >Модел за изтриване</label>							
									<div>
