...
<head>
	<title>Грешка Търсене на Устройство</title>
	<meta charset="utf-8">
				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-red">							
						<div class="panel-heading panel-red-heading">
							<div class="panel-title text-center">Грешка Търсене на Устройство!</div>
						</div>
						...
						<div class="panel-body">																
							<div class="well well-result text-center" >
								...
								&nbsp;Сериен номер на устройство е изтрит!											
								
							</div>								
							
							<div class="row"> 	   
								<div class="text-center">
									<a class="btn btn-default btn-center" href="${pageContext.request.contextPath}/search/selectItem" role="button">Към Търсене</a>
								</div>	
							</div><!-- end row -->
