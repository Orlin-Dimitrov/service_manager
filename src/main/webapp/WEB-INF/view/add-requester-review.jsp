...
<head>
	<title>Преглед на НОВ Заявител</title>
	<meta charset="utf-8">
					...
					<div class="row" >
						<div class="col-xs-12" >				
							<div class="panel panel-object" id="panelObjectInfo">
								<div class="panel-heading ">Заявител за Добавяне</div>
							
								<table class="table ">								
									<tr>
										<td class="col-xs-4 right">Заявител</td>
										<td class="col-xs-8 text-center active-object" >${newRequester.name}</td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Само Администратор може да променя или изтрива Заявител!</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/component/addRequester"
													   modelAttribute="newRequester"
												       class="form-horizontal"
												       method="POST">
									<form:hidden id="nameEdit" path="name" value="${newRequester.name}" />								
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/component/saveRequester"
													   modelAttribute="newRequesterForSaving"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="nameSave" path="name" value="${newRequester.name}" />		
