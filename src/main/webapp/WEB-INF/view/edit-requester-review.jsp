...
<head>
	<title>Преглед на Редактиране на Заявител</title>
	<meta charset="utf-8">
					...
					<div class="row" >
						<div class="col-xs-12" >				
							<div class="panel panel-object" id="panelObjectInfo">
								<div class="panel-heading ">Редактиран Заявител</div>
							
								<table class="table ">								
									<tr>
										<td class="col-xs-4 right">Заявител </td>
										<td class="col-xs-8 text-center active-object" >${editRequester.name}</td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Тази промяна се отнася за Заявител:</div>
									
									<div class="modifiedObject">
										${editRequester.oldName}
									</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/componentEdit/editRequester"
													   modelAttribute="editRequester"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="nameEdit" path="name" value="${editRequester.name}" />
									<form:hidden id="idEdit" path="id" value="${editRequester.id}" />									
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/componentEdit/saveEditRequester"
													   modelAttribute="editRequesterForSaving"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="nameSave" path="name" value="${editRequester.name}" />
									<form:hidden id="idSave" path="id" value="${editRequester.id}" />	
