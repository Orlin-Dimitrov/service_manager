...
<head>
	...
	<title>Добави Сериен номер на Устройство</title>
	<meta charset="utf-8">
	...
	<script type="text/javascript">
		...
		var typeId = <c:out value="${newObjectInstance.typeId}" />;
		var modelId = <c:out value="${newObjectInstance.modelId}" />;
				...
				<div id="inputbox" class="mainbox">
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							<div class="panel-title">Добави НОВ Сериен номер на устройство</div>							
						</div>
		
						<div class="panel-body">

							<!-- Add Type Form -->
							<form:form action="${pageContext.request.contextPath}/component/reviewInstance"
									   modelAttribute="newObjectInstance" 
									   method="POST" 
								       class="form-horizontal"
								       id="addNewInstanceForm">								
								...
								<div class="row form-group form-group-custom">																																	
									<div>
										<label for="instance">Сериен номер</label>																													
									</div>
