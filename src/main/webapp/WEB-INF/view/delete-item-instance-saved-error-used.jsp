...
<head>
	<title>Грешка при изтриване Сериен номер на устройство</title>
	<meta charset="utf-8">
				...
				<div id="info-box" class="mainbox">
					<div class="panel panel-red">							
						<div class="panel-heading panel-red-heading">
							<div class="panel-title text-center">Грешка при изтриване Сериен номер!</div>
						</div>
						...
						<div class="panel-body">																
							<div class="well well-result text-center" >
								...
								&nbsp;Устройство с този Сериен номер се използва в Заявка											
