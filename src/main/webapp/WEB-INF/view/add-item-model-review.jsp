...
<head>
	<title>Преглед на НОВ Модел устройство</title>
	<meta charset="utf-8">
							...
							<div class="panel panel-object" id="panelObjectInfo">
								...
								<table class="table ">								
									<tr>
										...
										<td class="col-xs-8 text-center" >${newObjectModel.typeName}</td>
									</tr>
										
									<tr>
										<td class="right">Модел</td>
										<td class="active-object">${newObjectModel.model}</td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Само Администратор може да променя или изтрива Модел устройство!</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/component/addModel"
													   modelAttribute="newObjectModel"
												       class="form-horizontal"
												       method="POST">
									<form:hidden id="modelEdit" path="model" value="${newObjectModel.model}" />
									<form:hidden id="typeEdit" path="typeId" value="${newObjectModel.typeId}" />									
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/component/saveModel"
													   modelAttribute="newObjectModelForSaving"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="modelSave" path="model" value="${newObjectModel.model}" />
									<form:hidden id="typeSave" path="typeId" value="${newObjectModel.typeId}" />
