...
<head>
	<title>Преглед на НОВ Сериен номер на устройство</title>
	<meta charset="utf-8">
					...
					<div class="row" >
						<div class="col-xs-12" >				
							<div class="panel panel-object" id="panelObjectInfo">
								<div class="panel-heading ">Устройство за Добавяне</div>
							
								<table class="table ">								
									<tr>
										<td class="col-xs-4 right">Tип </td>
										<td class="col-xs-8 text-center" >${newObjectInstance.typeName}</td>
									</tr>
									
									<tr>
										<td class="right">Модел</td>
										<td>${newObjectInstance.modelName}</td>
									</tr>
									
									<tr>
										<td class="right">Сериен номер</td>
										<td class="active-object">${newObjectInstance.instance}</td>
									</tr>																											
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Само Администратор може да променя или изтрива Сериен номер на устройство!</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/component/addInstance"
													   modelAttribute="newObjectInstance"
												       class="form-horizontal"
												       method="POST">
									<form:hidden id="instanceEdit" path="instance" value="${newObjectInstance.instance}" />			       
									<form:hidden id="modelEdit" path="modelId" value="${newObjectInstance.modelId}" />
									<form:hidden id="typeEdit" path="typeId" value="${newObjectInstance.typeId}" />								
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/component/saveInstance"
													   modelAttribute="newObjectInstanceForSaving"
												       class="form-horizontal"
												       method="POST">
												       
									<form:hidden id="instanceSave" path="instance" value="${newObjectInstance.instance}" />			       
									<form:hidden id="modelSave" path="modelId" value="${newObjectInstance.modelId}" />
									<form:hidden id="typeSave" path="typeId" value="${newObjectInstance.typeId}" />	
