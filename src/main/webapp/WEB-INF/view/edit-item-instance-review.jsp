...
<head>
	<title>Преглед на Редактиран Сериен номер на Устройство</title>
	<meta charset="utf-8">
							...
							<div class="panel panel-object" id="panelObjectInfo">
								...
								<table class="table ">								
									<tr>
										...
										<td class="col-xs-8 text-center" >${editObjectInstance.typeName}</td>
									</tr>
									
									<tr>
										<td class="right">Модел</td>
										<td>${editObjectInstance.modelName}</td>
									</tr>
									
									<tr>
										<td class="right">Сериен номер</td>
										<td class="active-object">${editObjectInstance.instance}</td>
									</tr>
								</table>
							</div>
						</div>
						...
						<div class="col-xs-12 " >	
							<div class="panel panel-danger">
								...
								<div class="panel-body text-center">
									<div>Тази промяна се отнася за Сериен номер:</div>
									
									<div class="modifiedObject">
										${editObjectInstance.oldInstance}
									</div>
					...
					<div class="row ">
						<div class="col-xs-6 " >					  
							<div class="text-left form-group btn-left">
								<form:form action="${pageContext.request.contextPath}/componentEdit/editInstance"
													   modelAttribute="editObjectInstance"
												       class="form-horizontal"
												       method="POST">

									<form:hidden id="instanceEdit" path="instance" value="${editObjectInstance.instance}" />
									<form:hidden id="instanceIdEdit" path="instanceId" value="${editObjectInstance.instanceId}" />
									
									<form:hidden id="modelIdEdit" path="modelId" value="${editObjectInstance.modelId}" />

									<form:hidden id="typeIdEdit" path="typeId" value="${editObjectInstance.typeId}" />									
						...
						<div class="col-xs-6">							
							<div class="save text-right form-group btn-right">
								<form:form action="${pageContext.request.contextPath}/componentEdit/saveEditInstance"
													   modelAttribute="editObjectInstanceForSaving"
												       class="form-horizontal"
												       method="POST">												       
												       
									<form:hidden id="instanceSave" path="instance" value="${editObjectInstance.instance}" />
									<form:hidden id="instanceIdSave" path="instanceId" value="${editObjectInstance.instanceId}" />
									
									<form:hidden id="modelIdSave" path="modelId" value="${editObjectInstance.modelId}" />

									<form:hidden id="typeIdSave" path="typeId" value="${editObjectInstance.typeId}" />
