...
<head>
	...
	<title>Добави Тип Устройство</title>
	<meta charset="utf-8">
				...
				<div id="inputbox" class="mainbox">
					<div class="panel panel-primary" >
						...
						<div class="panel-heading">
							<div class="panel-title">Добави НОВ Тип устройство</div>
						</div>
		
						<div class="panel-body">
		
							<!-- Add Type Form -->
							<form:form action="${pageContext.request.contextPath}/component/reviewType"
								...
								<div class="row form-group form-group-custom">																																	
									<div>
										<label for="number">Наименование на Типа</label>																													
									</div>
